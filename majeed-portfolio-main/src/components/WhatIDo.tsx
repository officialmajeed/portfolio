        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DATA SCIENCE</h3>
              <h4>Uncovering Data Insights</h4>
              <p>
                Analyzing complex datasets to extract actionable insights.
                From exploratory data analysis to visualizations, I turn data into value.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Intelligent Predictive Models</h4>
              <p>
                Building intelligent systems to identify patterns and generate predictions.
                From regression and classification to deep neural networks.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Model Eval.</div>
